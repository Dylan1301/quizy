...
from core.db.room import create_room, get_room_detail, get_room, start_room, publish_room, delete_room, get_room_list, edit_room
...
def room_list(session: SessionDep, teacher: CurrentUserDep, quiz_id:int):
    # I have changed this method into get room based on quiz_id rather than get all teacher's room
    validate = get_quiz_owner_id(
